...
//     // Method 1: Direct print with CSS media queries (Recommended)
//     window.print();
    
//     // Method 2: If you need to modify content before printing
//     /*
//     let $printContent = $('#previewContent').clone();
    
//     // Create or update printable content
//     let $printableDiv = $('#printableContent');
//     if ($printableDiv.length === 0) {
//         $printableDiv = $('<div id="printableContent" class="print-only"></div>');
//         $('body').append($printableDiv);
//     }
    
//     $printableDiv.html($printContent.html()).css({
//         'display': 'none'  // Hide from screen, show only in print
//     });
    
//     // Force reflow to ensure content is rendered
//     $printableDiv[0].offsetHeight;
...
//     // Method 3: Open new window for printing (if you need more control)
//     /*
...
// // Add CSS for print styling (add this to your stylesheet)
// /*
// @media print {
...
//     // Hide other page elements during print
//     .modal, .navbar, .sidebar, button { 
