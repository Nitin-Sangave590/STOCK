...
<head>
    ...
    <style>
        ...
        @media print {
            body * { display: none; }
            #printWindowContent { display: block !important; }
            #printWindowContent .print-container { box-shadow: none !important; border: none !important; margin: 0 !important; padding: 25px 40px !important; border-radius: 0 !important; max-width: none !important; page-break-inside: avoid; }
...
$(document).ready(function() {
    ...
    // Print Now - Open new window with isolated content
    $('#printNowBtn').click(function() {
        let printContent = $('#previewContent').html();
        ...
        printWindow.document.write(`
            ...
            <head>
                <meta charset="UTF-8">
                <meta name="viewport" content="width=device-width, initial-scale=1.0">
                <title>Print Patti</title>
                <style>
                    body { font-family: Arial, sans-serif; margin: 0; padding: 0; background: white; }
                    .print-container { max-width: 800px; margin: 0 auto; background: #fff; padding: 25px 40px; }
                    .invoice-header { text-align: center; border-bottom: 2px solid #ddd; margin-bottom: 20px; padding-bottom: 10px; }
                    .invoice-header h2 { margin: 0; font-size: 28px; letter-spacing: 1px; }
                    .invoice-details p { margin: 4px 0; font-size: 16px; }
                    .table-container { margin-top: 20px; }
                    ...
                    @media print {
                        ...
                        .print-container { box-shadow: none !important; border: none !important; padding: 25px 40px !important; }
                    }
                </style>
            </head>
            <body>
                <div id="printWindowContent">${printContent}</div>
                <script>
