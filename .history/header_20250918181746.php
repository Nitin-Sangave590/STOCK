            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dataEntryDropdown">
                        ...
                        <li><a class="dropdown-item" href="Purchase_registerprint.php">Purchase Register Printing</a></li>
                        <li><a class="dropdown-item" href="bill_print.php">Sale Bill Printing</a></li>
