...
// Default date (today)
$selected_date = date('Y-m-d'); // Default to today: September 18, 2025, 11:47 AM IST
...
<div class="container">
    ...
    <div class="filter-form">
        <form method="POST" class="row g-2 justify-content-center">
            <div class="col-auto">
                <label class="form-label" style="color: #2c3e50;">Select Date:</label>
    ...
    <div class="card">
        ...
        <div class="card-body daywise-table">
            <table class="table table-striped">
                ...
                <tbody>
                    <?php
                    // Use the selected date for day-wise details
                    $purchase = !empty($purchase_date_data) ? $purchase_date_data[0] : ['qty' => 0, 'weight' => 0, 'amount' => 0];
                    $sale = !empty($sale_date_data) ? $sale_date_data[0] : ['qty' => 0, 'weight' => 0, 'amount' => 0];
                    echo "<tr>
