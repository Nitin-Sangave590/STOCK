...
<div class="container my-4">
    <h2 class="mb-4">Combine Regis</h2>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            ...
            <tfoot>
                <tr class="fw-bold">
                    <td colspan="11" class="text-end">Total Purchase</td>
                    <td><?= number_format($total_purchase, 2) ?></td>
                </tr>
                <tr class="fw-bold">
                    <td colspan="11" class="text-end">Total Sales</td>
                    <td><?= number_format($total_sales, 2) ?></td>
                </tr>
                <tr class="fw-bold">
                    <td colspan="11" class="text-end">Remaing Amount</td>
