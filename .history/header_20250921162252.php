            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dataEntryDropdown">
                        <li><a class="dropdown-item no-url" href="#" onclick="navigateTo('purchase_entry.php')">Patti Entry</a></li>
                        <li><a class="dropdown-item no-url" href="#" onclick="navigateTo('sale_entry.php')"> Bill Entry</a></li>
