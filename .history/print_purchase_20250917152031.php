...
$net_total = $purchase['total'] + $purchase['hamali'] + $purchase['freight'] + $purchase['uchal'];
?>
...
<div class="print-container">
    ...
    <div class="total-section">
        <p><strong>Subtotal:</strong> <?= number_format($purchase['total'], 2) ?></p>
        <p><strong>Hamali:</strong> <?= number_format($purchase['hamali'], 2) ?></p>
        <p><strong>Freight:</strong> <?= number_format($purchase['freight'], 2) ?></p>
        <p><strong>Uchal:</strong> <?= number_format($purchase['uchal'], 2) ?></p>
        <p class="total-amount"><strong>Net Total:</strong> <?= number_format($net_total, 2) ?></p>
    </div>
    <div class="invoice-header">
