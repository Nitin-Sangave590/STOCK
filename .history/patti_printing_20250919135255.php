...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            #previewContent { position: absolute; left: 0; top: 0; width: 100%; }
            ...
            .modal, .modal-backdrop, .modal-header, .modal-footer, .container, .card, .pagination, button, .btn, nav, h2, h4 { display: none !important; }
        }
    </style>
...
$(document).ready(function() {
    ...
    // Print Now - Simplified for reliability
