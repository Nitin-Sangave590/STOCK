...
<head>
    ...
    <style>
        ...
        @media print {
            body * { display: none; }
            #printableContent, #printableContent * { display: block !important; visibility: visible !important; }
            #printableContent { position: absolute; top: 0; left: 0; width: 100%; height: auto; margin: 0; padding: 0; }
            .print-container { box-shadow: none; border: none; margin: 0; padding: 25px 40px; border-radius: 0; max-width: none; page-break-inside: avoid; }
        }
    </style>
...
$(document).ready(function() {
    ...
    // Print Now - Clone content to ensure proper printing
    $('#printNowBtn').click(function() {
        let $printContent = $('#previewContent').clone();
        $('#printableContent').html($printContent.html()).show();
        setTimeout(function() {
            window.print();
