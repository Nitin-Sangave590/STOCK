        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dataEntryDropdown">
                        <li><a class="dropdown-item" href="patti_print.php">Purchase Entry</a></li>
                        <li><a class="dropdown-item" href="bill_print.php">Sale Bill Entry</a></li>
                        <li><a class="dropdown-item" href="customer_receipt_print.php">Customer Receipt</a></li>
                        <li><a class="dropdown-item" href="supplier_payment_print.php">Supplier Payment</a></li>
                    </ul>
                </li>
