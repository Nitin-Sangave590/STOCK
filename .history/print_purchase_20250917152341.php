...
<div class="print-container">
    ...
    <div class="total-section">
        <p><strong>Total Product Amount:</strong> <?= number_format($product_total, 2) ?></p>
        <p><strong>Expenses:</strong></p>
        <p>&nbsp;&nbsp;Hamali: <?= number_format($purchase['hamali'], 2) ?></p>
        <p>&nbsp;&nbsp;Freight: <?= number_format($purchase['freight'], 2) ?></p>
        <p>&nbsp;&nbsp;Uchal: <?= number_format($purchase['uchal'], 2) ?></p>
        <p><strong>Total Expenses:</strong> <?= number_format($total_expenses, 2) ?></p>
        <p class="total-amount"><strong>Net Amount:</strong> <?= number_format($net_amount, 2) ?></p>
    </div>
    <div class="invoice-header">
