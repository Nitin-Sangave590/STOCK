            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<tr>
                        ...
                        <td>{$row['total_purch_qty']}</td>
                        <td>{$row['total_purch_weight']}</td>
                        <td>{$row['total_sold_qty']}</td>
                        <td>{$row['total_sold_weight']}</td>
                        <td><strong>{$row['available_qty']}</strong></td>
                        <td><strong>{$available_weight}</strong></td>
                    </tr>";
                }
                $stmt->close();
                ?>
