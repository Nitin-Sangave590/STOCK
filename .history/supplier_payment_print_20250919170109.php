<?php
// payment_receipt_printing.php - Supplier Payment Receipt Printing with A5 Page Size Support
ob_start();
include 'db.php';
include 'header.php';
    ...
    if (!empty($selected_ids)) {
        ...
        if ($stmt_details) {
            ...
            foreach ($selected_ids as $id) {
                ...
                $preview_content .= '<h5>Payment Receipt</h5>';
                $preview_content .= '</div>';
...
<head>
    ...
    <title>Supplier Receipt Register</title>
...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="fw-bold">Payment Receipt Register</h2>
    </div>
    ...
    <div class="card shadow p-3">
        ...
        <h4 class="fw-bold mb-3">📋 Payment Receipt List</h4>
...
<div class="modal fade no-print" id="successModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="payment_receipt_printing.php?page=<?= $page ?>" class="btn btn-primary">Back to Receipt List</a>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    function loadPreview(ids, action) {
        ...
        $.post('payment_receipt_printing.php', postData, function(response) {
    ...
    $('#whatsappBtn').click(function() {
        ...
        $.post('payment_receipt_printing.php', { selected_ids: selectedIds, whatsapp: true, start_date: $('[name="start_date"]').val(), end_date: $('[name="end_date"]').val(), page: <?= $page ?> }, function(response) {
