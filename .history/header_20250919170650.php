        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dataEntryDropdown">
                        <li><a class="dropdown-item" href="patti_printing.php">Patti Printing</a></li>
                        <li><a class="dropdown-item" href="bill_printing.php">Bill Printing</a></li>
                        <li><a class="dropdown-item" href="patti_register_print.php">Purchase Register Printing</a></li>
                        <li><a class="dropdown-item" href="bill_register_print.php">Sale Register Printing</a></li>
                        ...
                        <li><a class="dropdown-item" href="daywise_purchase_sale_report.php">Day Wise Transection Report </a></li>
                    </ul>
                </li>
