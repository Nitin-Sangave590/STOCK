...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <option>
                <ul class="navbar-nav">ITEM & ACCOUNT
                    <select name="" id="">
                ...
                <ul>     
                  ...
                  <option>
                <ul class="navbar-nav">data Entry
                    <select name="" id="">
                ...
                <li class="nav-item"><a class="nav-link" href="supplier_payment.php">Supplier Payment</a></li>
                  ...
                  <option>
                <ul class="navbar-nav">Daily Reports
                    <select name="" id="">
                          <li class="nav-item"><a class="nav-link" href="purchase_register.php">Purchase resister</a></li>
                <li class="nav-item"><a class="nav-link" href="sale_register.php">Sale Bill resister</a></li>
                <li class="nav-item"><a class="nav-link" href="combine_resister.php">Combine Register</a></li>
