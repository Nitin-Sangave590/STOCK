...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .modal, .container, .card, .pagination, button, .btn { display: none; }
        }
    </style>
...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="fw-bold">Patti Printing</h2>
    </div>
...
$(document).ready(function() {
    ...
    $('#previewBtn').click(function() {
        ...
        $.post('patti_printing.php', { selected_ids: selectedIds, preview: true, start_date: $('[name="start_date"]').val(), end_date: $('[name="end_date"]').val(), page: <?= $page ?> }, function(response) {
            $('#previewContent').html($(response).find('#previewContent').html());
    ...
    $('.single-preview-btn').click(function() {
        ...
        $.post('patti_printing.php', { single_preview: purchaseId, start_date: $('[name="start_date"]').val(), end_date: $('[name="end_date"]').val(), page: <?= $page ?> }, function(response) {
            $('#previewContent').html($(response).find('#previewContent').html());
            $('#printPreviewModal').modal('show');
            $('#printBtn').prop('disabled', false);
        });
