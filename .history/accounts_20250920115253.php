...
<div class="container mt-4">
    ...
    <?php else: ?>
        ...
        <div class="d-flex justify-content-between mb-3">
            ...
            <a href="accounts.php?action=add&type=<?php echo $account_type; ?>" class="btn btn-success shadow-sm">➕ Add New Account</a>
        </div>

        <!-- Accounts Table -->
        <div class="card card-custom p-3">
            <h4 class="text-dark mb-3">📋 <?php echo ucfirst($account_type === 'all' ? 'All Accounts' : $account_type . 's'); ?>
                <a href="index.php" id="closeaccountmas" class="btn btn-danger">❌</a>
            </h4>
