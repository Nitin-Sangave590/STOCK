    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="customer_receipt.php">Customer Receipt Entry</a></li>
                <li class="nav-item"><a class="nav-link" href="supplier_payment.php">Supplier Payment Entry</a></li>
