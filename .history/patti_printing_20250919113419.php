...
$(document).ready(function() {
    ...
    $('#previewBtn').click(function() {
        ...
        $.post('print_purchase.php', { selected_ids: selectedIds, preview: true, start_date: $('[name="start_date"]').val(), end_date: $('[name="end_date"]').val(), page: <?= $page ?> }, function(response) {
    ...
    $('#printNowBtn').click(function() {
        ...
        $.post('print_purchase.php', { selected_ids: selectedIds, print: true, start_date: $('[name="start_date"]').val(), end_date: $('[name="end_date"]').val(), page: <?= $page ?> }, function(response) {
            window.print();
