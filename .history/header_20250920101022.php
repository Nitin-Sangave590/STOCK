            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="printingDropdown">
                        ...
                        <li><a class="dropdown-item no-url" href="#" onclick="navigateTo('shop_expenses.php')">Home Expenses</a></li>
                        <li><a class="dropdown-item no-url" href="#" onclick="navigateTo('shop_expenses.php')">Other Expenses</a></li>
                    </ul>
                </li>
