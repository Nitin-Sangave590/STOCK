...
if ($action === 'add' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->query($sql)) {
        header("Location: combined_register.php?type=$transaction_type");
        exit;
    } else {
        ...
        <div class="card-custom">
            ...
            <form method="POST">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="combined_register.php?type=<?php echo $transaction_type; ?>" class="btn btn-secondary">❌ Cancel</a>
                </div>
            </form>
        </div>
    <?php else: ?>
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link <?php echo $transaction_type === 'all' ? 'active' : ''; ?>" href="combined_register.php?type=all">All Transactions</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo $transaction_type === 'purchase' ? 'active' : ''; ?>" href="combined_register.php?type=purchase">Purchases</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo $transaction_type === 'sale' ? 'active' : ''; ?>" href="combined_register.php?type=sale">Sales</a>
            </li>
        </ul>
        ...
        <div class="d-flex justify-content-between mb-4">
            ...
            <a href="combined_register.php?action=add&type=<?php echo $transaction_type; ?>" class="btn btn-success">➕ Add New Transaction</a>
        </div>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center mt-4">
                        <li class="page-item <?php echo $page <= 1 ? 'disabled' : ''; ?>">
                            <a class="page-link" href="combined_register.php?type=<?php echo $transaction_type; ?>&search=<?php echo urlencode($search); ?>&page=<?php echo $page - 1; ?>">Previous</a>
                        </li>
                        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                            <li class="page-item <?php echo $i === $page ? 'active' : ''; ?>">
                                <a class="page-link" href="combined_register.php?type=<?php echo $transaction_type; ?>&search=<?php echo urlencode($search); ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                            </li>
                        <?php endfor; ?>
                        <li class="page-item <?php echo $page >= $total_pages ? 'disabled' : ''; ?>">
                            <a class="page-link" href="combined_register.php?type=<?php echo $transaction_type; ?>&search=<?php echo urlencode($search); ?>&page=<?php echo $page + 1; ?>">Next</a>
                        </li>
                    </ul>
                </nav>
            <?php endif; ?>
