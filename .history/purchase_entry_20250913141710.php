...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    for ($i = 0; $i < count($_POST['item_id']); $i++) {
        ...
        $rate = $_POST['rate'][$i];
        $total = $quantity * $rate; // Assuming total based on qty * rate, adjust if weight involved
    ...
    echo "<div class='alert alert-success'>Purchase added successfully! Purchase ID: $purchase_id</div>";
}
?>
