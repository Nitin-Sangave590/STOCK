<?php
// purchase_entry.php - Purchase Entry (with Edit + Expense Deduction)
include 'db.php';
include 'header.php';
...
if (($action === 'add' || $action === 'edit') && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add') {
        ...
        $stmt->execute();
        $stmt->close();
        $conn->query("DELETE FROM purchase_details WHERE purchase_id={$purchase_id}"); // Reset details on edit
    }
    ...
    // Deduct hamali + freight + uchal from total
        ...
        <form method="POST" id="purchaseForm" action="purchase_entry.php?action=add">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="invoice_number" id="invoice_number" class="form-control" value="<?= $next_invoice ?>" readonly>
                </div>
                <div class="col-md-4">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="uchal" id="uchal" class="form-control" value="0">
                </div>
            </div>

            <!-- Grand Total -->
            <div class="mb-3">
                <label class="form-label">Net Total (After Deductions)</label>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <td><button class='btn btn-sm btn-warning edit-btn' data-id='{$row['id']}'>✏ Edit</button></td>
                    </tr>";
                }
                ?>
            </tbody>
...
$(document).ready(function(){
    ...
    $(document).on('change', '.item-select', calculateTotals);
