    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            ...
            while ($row = $result_sales->fetch_assoc()) {
                ...
                $sum_sales_rate += $row['rate'];
                $sales_count++;
            }

            // Calculate average rates
            $avg_purchase_rate = $purchase_count > 0 ? $sum_purchase_rate / $purchase_count : 0;
            $avg_sales_rate = $sales_count > 0 ? $sum_sales_rate / $sales_count : 0;
            $remaining_avg_rate = $avg_sales_rate - $avg_purchase_rate;
            ...
            <tfoot>
                <tr class="fw-bold">
                    ...
                    <td><?= number_format($avg_purchase_rate, 2) ?></td>
                ...
                <tr class="fw-bold">
                    ...
                    <td><?= number_format($avg_sales_rate, 2) ?></td>
                ...
                <tr class="fw-bold">
                    ...
                    <td><?= number_format($remaining_avg_rate, 2) ?></td>
