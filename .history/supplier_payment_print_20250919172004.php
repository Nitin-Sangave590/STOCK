<?php
// supplier_payment_print.php - Supplier Payment Receipt Printing with A5 Page Size Support
ob_start();
include 'db.php';
include 'header.php';
    ...
    if (!empty($selected_ids)) {
        ...
        if ($stmt_details) {
            ...
            foreach ($selected_ids as $id) {
                ...
                $preview_content .= '<h6>दुकान क्रमांक २, करिबेश्वर कॉम्प्लेक्स, मेन रोड, कासार शिरसी Mo.No 8208893491</h6>';
...
<div class="modal fade no-print" id="successModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="supplier_payment_print.php?page=<?= $page ?>" class="btn btn-primary">Back to Receipt List</a>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    function loadPreview(ids, action) {
        ...
        $.post('supplier_payment_print.php', postData, function(response) {
    ...
    $('#whatsappBtn').click(function() {
        ...
        $.post('supplier_payment_print.php', { selected_ids: selectedIds, whatsapp: true, start_date: $('[name="start_date"]').val(), end_date: $('[name="end_date"]').val(), page: <?= $page ?> }, function(response) {
