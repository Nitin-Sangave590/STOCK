            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <td><a href='Print_purchase.php?action=edit&id={$row['id']}&page={$page}' class='btn btn-sm btn-outline-secondary'>✏ Edit</a></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="Print_purchase.php?page=<?= $page ?>" class="btn btn-primary">Back to Purchase List</a>
            </div>
        </div>
    </div>
</div>
