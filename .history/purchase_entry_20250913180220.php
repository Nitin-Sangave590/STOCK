...
if ($action == 'add' && $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $conn->query("INSERT INTO purchases (supplier_id, invoice_number, purchase_date, hamali, freight, total_amount) 
    ...
    for ($i = 0; $i < count($_POST['item_id']); $i++) {
        ...
        $total = $weight * $rate; // ✅ weight * rate calculation
        $total_amount += $total;
...
$(document).ready(function() {
    ...
    function calculateTotals() {
        ...
        let netTotal = grandTotal - hamali - freight;
