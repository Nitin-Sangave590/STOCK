<?php
// shop_expenses.php - Shop Expenses Entry & Ledger with Pagination, Total & Date Filter
include 'db.php';
include 'header.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $expense_type = trim($_POST['expense_type']); // CHANGED: free text input
    ...
    if (!$expense_date || $amount <= 0 || empty($expense_type)) {
        ...
        if ($action === 'add') {
            // ✅ New table structure supports text-based type
            $sql = "INSERT INTO shop_expenses (expense_type_text, expense_date, amount, description, paid_by, created_at) 
                    VALUES (?, ?, ?, ?, ?, NOW())";
...
if (!empty($filter_date)) {
    $where_sql = "WHERE se.expense_date = ?";
    $params[] = $filter_date;
    $types .= "s";
}
...
// ---------- COUNT TOTAL ROWS ----------
$count_sql = "SELECT COUNT(*) as total FROM shop_expenses se $where_sql";
...
// ---------- FETCH EXPENSES ----------
$list_sql = "SELECT se.* FROM shop_expenses se $where_sql ORDER BY se.id DESC LIMIT ? OFFSET ?";
...
<div class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="fw-bold">📑 Shop Expenses</h2>
    ...
    <div class="card shadow-sm p-4">
        <form method="POST" class="row g-3">
            <div class="col-md-6">
                ...
                <input type="text" name="expense_type" class="form-control" placeholder="Enter expense type" required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-8">
                ...
                <input type="text" name="paid_by" class="form-control" placeholder="Cash / Bank / Card">
            </div>
            <div class="col-12">
            ...
            <div class="col-12 d-flex justify-content-end">
                ...
                <a href="shop_expenses.php" class="btn btn-secondary">❌ Cancel</a>
            </div>
        </form>
    </div>
    ...
    <form method="GET" class="row g-3 mb-3">
        ...
        <div class="col-md-3 align-self-end">
            ...
            <a href="shop_expenses.php" class="btn btn-secondary">Reset</a>
        </div>
    </form>
